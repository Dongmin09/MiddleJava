...
public class T14ThreadShareTest {
/*
 	스레드에서 데이터를 공통으로 사용하는 방법
 		스레드끼리 정보를 데이터를 주고 받아야 할 때 공유 객체가 있으면 서로 정보를 주고받을수 잇다.
 		멀티 스레드 상황에서 발생한다.
...
class ShareData {
	 ...
	 */
	volatile private boolean isOK = false; // 원주율계산이 완료되었는지를 나타내는 변수
