...
/*
 	...
 	ReentrantLook : Read 및 Write 구분없이 사용하기 위한 락 클래스로 동기화처리를 위해
 ...
 */
	public static void main(String[] args) {
		...
		ReentrantLock lock = new ReentrantLock(true);// 락 개체 생성 
...
class LockAccount {
	...
	public void deposit(int money) {
		// Lock객체의 lock()메서드 동기화의 시작이고, unlock()메서드가
		// 동기화의 끝을 나타낸다.
	...
	// 출금하는 메서드 (출금 성공: true, 출금 실패: false를 반환함)
