...
//	}
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("서블릿 API의 메이져 버젼 정보 : " + ctx.getMajorVersion());
		System.out.println("서블릿 API의 마이너 버젼 정보 : " + ctx.getMinorVersion());
		...
		// 속성값 가져오기
		System.out.println("attr1 속성값  : " + ctx.getAttribute("attr1"));
