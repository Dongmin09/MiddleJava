...
public class T03ByteArrayIOTest {
	public static void main(String[] args) {
		...
		// 1. 직접 복사하기
//		outSrc = new byte[inSrc.length]; // 배열공간확보
//	//	outSrc = new byte[10];  크기를 알고있으면 직접 지정해주어도 된다.
...
//		 System.out.println("arraycopy 후 outSrc => " + Arrays.toString(outSrc));
		...
		// 3. 스트림 객체 생성하기
		ByteArrayInputStream bais = new ByteArrayInputStream(inSrc); // 프로그램 기준으로 데이터를 가져오는 것
