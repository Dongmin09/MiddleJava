...
public interface IMemberDAO {
	 ...
	 * @param vo DB에 insert할 자료가 저장된 MemberVO객체
	 ...
	 * @return 해당 회원이 존재하면 true, 없으면 false 반환됨.
	 */
	public boolean checkMember(String memId);
	
	/**
	 * 하나의 MemberVO자료를 이용하여 DB를 update하는 메서드
	 * @param vo 수정할 회원정보가 들어있는 MemberVO객체
	 * @return 작업 성공 : 1, 작업 실패 0 반환됨.
	 */
	...
	/**
	 * 검색할 회원 정보를 담은 MemberVO 객체를 이용하여 회원 정보를 조회하는 메서드
	 * @param vo 검색할 회원 정보를 담은 MemberVO 객체
